...
def main():
    ...
    argument_spec = dict(
        ...
        ssh_key_data=dict(type='str', no_log=True),
        ssh_key_unlock=dict(type='str', no_log=True),
        authorize=dict(type='bool', default=False),
        authorize_password=dict(type='str', no_log=True),
        ...
        become_method=dict(type='str'),
        become_username=dict(type='str'),
        become_password=dict(type='str', no_log=True),
    ...
    for legacy_input in OLD_INPUT_NAMES:
        if module.params.get(legacy_input):
